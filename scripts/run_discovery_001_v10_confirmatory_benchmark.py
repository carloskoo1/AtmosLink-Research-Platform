...
OUT=ROOT/"Results/scientific_discovery/DISCOVERY-001/v10"
    ...
    for lag in LAGS:
        for seed in range(TRIALS):
            sim,_=inject_array(base,event_idx,lag//5,effect,scale,
                               duration_steps=3,activation_prob=.70,seed=70000+seed)
...
summary={
    "experiment_id":"DISCOVERY-001","version":"10.0-confirmatory-synthetic-benchmark",
