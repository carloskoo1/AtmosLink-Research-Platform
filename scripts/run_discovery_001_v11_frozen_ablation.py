...
SRC=ROOT/"Results/scientific_discovery/DISCOVERY-001/v10_fixed180/benchmark_trials.csv"
OUT=ROOT/"Results/scientific_discovery/DISCOVERY-001/v11_ablation"
...
payload={
    ...
    "version":"11a.0-frozen-threshold-180min-ablation",
    "validation_accessed":False,
    "source":"v10_fixed180 exploratory frozen-threshold trials",
    "false_positive_rates":fpr.to_dict(orient="records"),
    "moderate_signal_recovery":moderate.to_dict(orient="records"),
}
(OUT/"v11_summary.json").write_text(json.dumps(payload,indent=2,default=str)+"\n")
