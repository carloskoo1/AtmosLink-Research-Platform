#!/usr/bin/env python3
# Exploratory calibration variant retained for provenance.
# Uses 60-minute driver refractory spacing and is not the frozen final benchmark.
...
OUT=ROOT/"Results/scientific_discovery/DISCOVERY-001/v10_frozen60_calibration"
...
driver_events,_=peak_events(driver_score(X),quantile=.85,refractory_min=60)
...
summary={
    ...
    "version":"10a.0-frozen-threshold-60min-calibration",
