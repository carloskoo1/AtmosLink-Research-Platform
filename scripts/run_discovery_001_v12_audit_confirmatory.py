    ...
    for lag in LAGS:
        for seed in range(TRIALS):
            sim,_=inject_array(base,driver_idx,lag//5,effect,scale,
                               duration_steps=3,activation_prob=.70,seed=90000+seed)
...
summary={
    ...
    "version":"12.0-audit-grade-confirmatory",
    "protocol_commit":"1e49129",
    "injection_seed_range":"90000-90099",
    "null_rng_seed":2026092602,
...
(OUT/"v12_summary.json").write_text(json.dumps(summary,indent=2,default=str)+"\n")
