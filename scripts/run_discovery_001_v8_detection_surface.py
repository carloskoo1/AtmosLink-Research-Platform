...
OUT=ROOT/"Results/scientific_discovery/DISCOVERY-001/v8"
...
events,_=peak_events(driver_score(X),quantile=.85,refractory_min=60)
...
summary={
    "experiment_id":"DISCOVERY-001","version":"8.0-detection-surface",
